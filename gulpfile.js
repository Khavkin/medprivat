...
var gulp = require('gulp'),
	...
	// autoprefix = new LessAutoprefix({ browsers: ['last 9 versions', 'ie 9'] }),
	browserSync = require('browser-sync').create();


gulp.task('css', function(cb){
	gulp.src(['node_modules/normalize.css/normalize.css','src/css/main.less'])
		.pipe(sourcemaps.init())
		.pipe(less())
		.pipe(autoprefixer({browsers: ['last 9 versions', 'ie 8']}))
...
gulp.task('syncandwatch', function(cb){
